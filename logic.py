...
import config
import math  # REQUIRED for precision math
...
# --- PRECISION SYSTEM (Fixed for Error -1111) ---
...
# --- EXECUTION (Fixed for Error -4120 and Live Log) ---
def execute_trade_action(balance, symbol, side, entry, order_type, sl_type, sl_value, sizing, user_units, user_lev, margin_mode):
    ...
    try:
        ...
        # 1. Format Quantity using string truncation
        ...
        # 4. LOG TO SESSION (Makes it appear in Live Log immediately)
        ...
        return {"success": True, "message": f"Trade successful! SL set at {sl_price}"}
